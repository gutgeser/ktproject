DELIMITER $$
DROP PROCEDURE IF EXISTS generic_procedure_two $$
CREATE PROCEDURE generic_procedure_two()
BEGIN
...
#     FROM locations WHERE l_Area = lbl;
#
#     IF loc_count = 0 THEN
...
#   SET no_more_records = 0;
 ...
 # END IF;
  ...
  SELECT 'PROCEDURE TWO FINISHED EXECUTING';
END $$
DELIMITER ;
